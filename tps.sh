...
\tNote: This option can be used multiple times."
	...
	export -f errcho error_exit \
			variable_exists variable_not_exists set_variable command_exists \
			pushdq popdq
 ...
 * int, integer: signed integer formet
 * uint, unsigned_integer: unsigned integer formet
 * decimal: signed decimal formet for real numbers
 * udecimal, unsigned_decimal: unsigned decimal formet for real numbers
...
" "${pattern}" "${substitute}" "${file_path}" "${tmp_file_path}"
